!(function (t, e) {
        ...
        U =
            ...
            (function (h) {
                ...
                if (
                    ...
                    !(i =
                        !(i = !(i = "undefined" != typeof globalThis && globalThis.crypto ? globalThis.crypto : i) && "undefined" != typeof window && window.msCrypto ? window.msCrypto : i) && "undefined" != typeof global && global.crypto
                            ? global.crypto
    ...
    function T(t) {
        ...
        return (
            255 == ((t >> 24) & 255)
                ? ((r = (t >> 8) & 255), (i = 255 & t), 255 === (e = (t >> 16) & 255) ? ((e = 0), 255 === r ? ((r = 0), 255 === i ? (i = 0) : ++i) : ++r) : ++e, (t = 0), (t += e << 16), (t += r << 8), (t += i))
                : (t += 1 << 24),
            t
        );
    }
    ...
    return (
        ...
        (w.enc.Base64 = {
            stringify: function (t) {
                ...
                for (var n = [], o = 0; o < r; o += 3)
                    for (
                        var s = (((e[o >>> 2] >>> (24 - (o % 4) * 8)) & 255) << 16) | (((e[(o + 1) >>> 2] >>> (24 - ((o + 1) % 4) * 8)) & 255) << 8) | ((e[(o + 2) >>> 2] >>> (24 - ((o + 2) % 4) * 8)) & 255), c = 0;
                        c < 4 && o + 0.75 * c < r;
                        c++
                    )
        ...
        (F.enc.Base64url = {
            stringify: function (t, e = !0) {
                ...
                for (var o = [], s = 0; s < i; s += 3)
                    for (
                        var c = (((r[s >>> 2] >>> (24 - (s % 4) * 8)) & 255) << 16) | (((r[(s + 1) >>> 2] >>> (24 - ((s + 1) % 4) * 8)) & 255) << 8) | ((r[(s + 2) >>> 2] >>> (24 - ((s + 2) % 4) * 8)) & 255), a = 0;
                        a < 4 && s + 0.75 * a < i;
                        a++
                    )
                ...
                e = (e.SHA256 = i.extend({
                    ...
                    _doProcessBlock: function (t, e) {
                        for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], s = r[3], c = r[4], a = r[5], h = r[6], l = r[7], f = 0; f < 64; f++) {
                            f < 16
                                ? (_[f] = 0 | t[e + f])
                                : ((d = _[f - 15]), (u = _[f - 2]), (_[f] = (((d << 25) | (d >>> 7)) ^ ((d << 14) | (d >>> 18)) ^ (d >>> 3)) + _[f - 7] + (((u << 15) | (u >>> 17)) ^ ((u << 13) | (u >>> 19)) ^ (u >>> 10)) + _[f - 16]));
                            var d = (i & n) ^ (i & o) ^ (n & o),
                    ...
                    for (
                        ...
                        L < 16
                            ...
                            : (($ = (q = e1[L - 15]).high),
                              ...
                              (Y = (Q = e1[L - 16]).high),
                              (T =
                                  (T = ((($ >>> 1) | (J << 31)) ^ (($ >>> 8) | (J << 24)) ^ ($ >>> 7)) + Z + ((j = (Z = ((J >>> 1) | ($ << 31)) ^ ((J >>> 8) | ($ << 24)) ^ ((J >>> 7) | ($ << 25))) + q) >>> 0 < Z >>> 0 ? 1 : 0)) +
        ...
        (F = F.RIPEMD160 = p.extend({
            ...
            _doProcessBlock: function (t, e) {
                ...
                for (
                    var o, s, c, a, h, l, f = this._hash.words, d = H.words, u = z.words, p = S.words, _ = x.words, y = b.words, v = A.words, g = (o = f[0]), B = (s = f[1]), w = (c = f[2]), k = (a = f[3]), m = (h = f[4]), r = 0;
                    r < 80;
                    r += 1
                )
                    (l = (o + t[e + p[r]]) | 0),
